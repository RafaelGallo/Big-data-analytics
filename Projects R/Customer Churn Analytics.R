...
library(readr)
churn <- read_csv("G:/Meu Drive/Machine learning e deep learning/Cursos - Google Drive/DSA/Formação cientista de dados 2.0/Big Data Analytics com R e Microsoft Azure Machine Learning/Cap06 - Tabalhando com bancos de dados relacionais e NoSQL em R/Telco-Customer-Churn.csv")
churn 
View(churn)
str(churn)
